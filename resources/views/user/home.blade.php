...
<meta charset="UTF-8">
  ...
  <title>Easy-Med - Medical Center </title>
...
<body>
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/bg-banner.jpg);">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        <span class="subhead">Let's make your life happier with</span>
        <h1 class="display-4">Easy-Med</h1>
